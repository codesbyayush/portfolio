 ...
 */
export const useClickAway = (ref: RefObject<HTMLElement>, onClickAway: () => void): ClickAwayListener => {
  ...
  const events: ('mousedown' | 'pointerdown' | 'touchstart')[] = ['mousedown', 'pointerdown', 'touchstart'];
